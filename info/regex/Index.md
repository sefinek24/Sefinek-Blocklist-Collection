# 🔧 Regex
Pi-hole allows you to use regular expressions to create [custom blocklists](List.md#-main-regular-expressions). This means you can block an entire domain or specific parts of a domain using a single rule.
