...
router.get('/generated/0.0.0.0/sites/ometv.txt', (req, res) => res.sendFile(`${ZeroZeroZeroZero}/sites/ometv.txt`));
...
router.get('/generated/127.0.0.1/sites/ometv.txt', (req, res) => res.sendFile(`${localhost}/sites/ometv.txt`));
...
router.get('/generated/noip/sites/ometv.txt', (req, res) => res.sendFile(`${noIp}/sites/ometv.txt`));
...
router.get('/generated/adguard/sites/ometv.txt', (req, res) => res.sendFile(`${adguard}/sites/ometv.txt`));
...
router.get('/generated/dnsmasq/sites/ometv.txt', (req, res) => res.sendFile(`${dnsmasq}/sites/ometv.txt`));
