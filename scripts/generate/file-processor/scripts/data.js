...
exports.CATEGORIES = [
	{
		...
		category: 'Anime',
		// grex "anime" "manga" "nekomimi" "nekomusume" "hentai" "cosplay" "otaku" "shonen" "shoujo" "yuri" "yaoi" "ecchi" "isekai" "kawaii" "tsundere" "yandere" "waifu" "seinen" "doujinshi" "bishounen" "shojo" "chibi" "bishojo" "doujin" "seiyuu" "harem" "meido" "lolicon" "fudanshi" "kuudere" "genki" "lightnovel" "wotaku"
		regex: /l(?:ightnovel|olicon)|(?:nekomusu|ani)me|(?:bishoun|s(?:ho|ei)n)en|(?:(?:doujins|ecc)h|fudansh|henta|iseka|kawai|chib|genk|y(?:ao|ur))i|nekomimi|tsundere|cosplay|bishojo|(?:yan|kuu)dere|doujin|seiyuu|w(?:otak|aif)u|(?:shou?j|meid)o|harem|manga|otaku/gi,
		file: 'anime/main.txt'
	},
	{
	...
	},
	{
		...
		description: 'Active + inactive domains + parked domains',
		category: 'E-Sport',
		...
		// grex "livesports" "thesport" "familjenesport" "simplesport" "cyclesport" "teamsport" "worldsport" "allsport" "realsport" "prosport" "schoolsport" "football" "basketball" "volleyball" "baseball" "athletics" "olympics" "marathon" "runningsport" "watersport" "motorsport" "outdoorsport"
		whitelist: /(?:familjen|th)esport|(?:running|(?:outdo|mot)or|w(?:ater|orld)|team|(?:rea|al)l|pro)sport|s(?:chool|imple)sport|livesports|(?:bas(?:ket|e)|foot)ball|volleyball|cyclesport|(?:athlet|olymp)ics|marathon/gi,
